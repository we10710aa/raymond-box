...
public class MainActivity extends AppCompatActivity {
    ...
    protected PollySpeechToText pollySpeechToText;
    protected MediaPlayer speechMediaPlayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        controller.setMediaPlayer(new MediaControllListener());
        ...
        pollySpeechToText =  new PollySpeechToText(
        ...
        textToSpeech = new TextToSpeech(MainActivity.this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int i) {
                ...
                Log.d("TextToSpeech",textToSpeech.getVoice().getLocale().toString());
            }
        });
    ...
    private void askKKAssistant(final String key) {
        ...
        request.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, final Response<JsonObject> response) {
                ...
                timeLog.setText(timeLog.getText()+"\n" + key+"spent(ms):"+(endTime-startTime)/1000000);
                Log.d("KKassistant result",response.body().toString());
                if(KKAssistant.parseShowText(response.body())!=null){
                    String text = KKAssistant.parseShowText(response.body());
                    if(!pollySwitch.isChecked()) {
                        ...
                        try {
                            ...
                            kklinx.pause();
                            speechMediaPlayer.prepareAsync();
                        } catch (ExecutionException e) {
                            Log.e("speechMediaPlayer", e.getMessage());
                            executeKKAssistantInstruction(response.body());
    ...
    class MediaControllListener implements MediaController.MediaPlayerControl{
        @Override
        public void start() {
            kklinx.resume();
        }
        ...
        @Override
        public void pause() { kklinx.pause(); }
